...
const coursework =
  "Algorithms · Data Structures · Machine Learning · Web Programming · Scalable Web Systems · Databases · Operating Systems · Data Science";

const honors =
  "Dean’s List · Chancellor’s Award · NYS Academic Excellence · National Merit Scholar · AP Scholar with Distinction · Commonwealth Honors College";
