...
export const ExperienceCard = ({
  ...
  const content = (
    <div className="group border border-border/40 rounded-xl p-6 hover:border-accent/50 hover:shadow-[0_0_20px_rgba(99,102,241,0.15)] hover:-translate-y-1 transition-all duration-300 bg-card/20 backdrop-blur-sm">
